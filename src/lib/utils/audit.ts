...
export type AuditAction =
	...
	| 'equipment.update'
	| 'equipment.delete'
	| 'equipment.movement.requested'
	| 'equipment.movement.approved'
	| 'equipment.movement.rejected'
	| 'equipment.movement.completed'
	| 'equipment.maintenance.registered'
	| 'equipment.maintenance.updated'
	| 'location.create'
	| 'location.update'
	| 'location.delete';
